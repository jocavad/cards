  ...
  $( function() {
    ...
    <body>
        <f:form id="f1" action="modify" method="post" modelAttribute="CrdRec">
            ...
            <table border="0">
            <tr><td><s:message code="crd.BankApprovalId"/></td><td><f:input path="bankApproval" size="50"/></td><td><img id="baPopup" src="<c:url value="/img/magnifier.png"/>" width="15" height="15" style="cursor: pointer;" /></td><td><f:errors path="bankApproval"/></td></tr>
         ...
         <jsp:include page="/bankApproval/list">
